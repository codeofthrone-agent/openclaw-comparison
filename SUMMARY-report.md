...
### 13 變體 + OpenClaw 核心 · 全景對比矩陣

```
┌─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐
│                                    OPENCLAW 生態系全景矩陣 (13 + 1)                                             │
├─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤
│                                                                                                                 │
│  400K ┤                                                                                        ★ OpenClaw      │
│       │                                                                                  ★ NanoBot             │
...
│       │                                                                                                         │
│       └────┬────────────┬────────────┬────────────┬────────────┬────────────┬────────────┬────────────┤          │
│         Rust         Python       TypeScript      Go           Zig         Rust         TS/Rust      分類       │
│                                                                                                                 │
└─────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
```
...
```
            ...
            ▼          ▼          ▼          ▼           ▼          ▼
       ┌────────┐ ┌────────┐┌──────────┐┌────────┐┌──────────┐┌────────┐
       │全能核心│ │輕量備選│ │極致效能  ││安全隔離││企業/全場景│ │UI擴展 │
       └───┬────┘ └───┬────┘└────┬─────┘└───┬────┘└────┬─────┘└───┬────┘
           │          │          │          │          │          │
      OpenClaw │  NanoBot  │  ZeroClaw  │  IronClaw  │ LobsterAI │ RivonClaw
               │  NanoClaw │  NullClaw  │  Moltis    │ TinyAGI   │
               │  CoPaw    │  ZeptoClaw │  NanoClaw  │ CoPaw     │
               │           │  PicoClaw  │            │           │
```
...
> **設計哲學**：「降低入門門檻」— 用更簡單的語言或架構提供 OpenClaw 的核心功能。
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╸
 ...
 平台                  │ 支援的專案數量（滿分14）
───────────────────────┤
 WhatsApp              │ ████████████████████  OpenClaw/NanoBot/ZeroClaw/NanoClaw/TinyAGI...
 Telegram              │ ████████████████████  OpenClaw/NanoBot/ZeroClaw/NanoClaw/IronClaw/TinyAGI
 Discord               │ ████████████████░░░░  OpenClaw/NanoBot/ZeroClaw/NanoClaw/TinyAGI/NullClaw...
 Signal                │ █████████████░░░░░░░  OpenClaw/ZeroClaw/NullClaw
 Slack                 │ █████████████░░░░░░░  OpenClaw/NanoBot/ZeroClaw/NanoClaw/IronClaw/NullClaw
 iMessage/BlueBubbles  │ █████████░░░░░░░░░░░  OpenClaw/ZeroClaw
 Matrix                │ ██████████░░░░░░░░░░  OpenClaw/NanoBot/ZeroClaw/NullClaw
 ...
 Gmail/Email          │ ██████░░░░░░░░░░░░░░  NanoBot/ZeroClaw/NanoClaw
 Mattermost            │ ████████░░░░░░░░░░░░  OpenClaw/ZeroClaw
 ...
 Zalo (越南通訊)       │ ██████░░░░░░░░░░░░░░  OpenClaw
 WebSocket/Web       │ ██████████████████░░░░  OpenClaw/IronClaw/ZeroClaw/PicoClaw/Moltis
...
```
 ...
 IM 即時通訊 ████████████████████████████████████  ~15 個
  ...
  企業通訊  ██████████████████                    ~7 個 (Teams/Slack/Mattermost/Nextcloud)
 中國平台  ████████████                            ~5 個 (微信/飛書/釘釘/QQ/企業微信)
 IoT 協議  ██████                                  MQTT/Serial/GPIO
 原生 App  ████████                                  macOS/iOS/Android
 瀏覽器    ████████                                  WebSocket/WebChat/REPL/CLI
```
...
│                                                          │
│  ② 語言分佈極度多樣化                                     │
│     TypeScript(5) Rust(5) Python(2) Go(1) Zig(1)          │
...
│     ZeroClaw(28平台) + PicoClaw(Sipeed) + NullClaw       │
│     從桌面擴展到嵌入式是下一波浪潮                           │
│                                                          │
└──────────────────────────────────────────────────────────┘
```
...
4. **📡 平台 Plugin SDK**：讓 NanoBot 等變體的獨家平台能被 OpenClaw 重用
